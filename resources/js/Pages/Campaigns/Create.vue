            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-surface-1 border border-border rounded-xl p-4">
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <p class="text-xs font-medium text-text-secondary">Checklist que se generará</p>
                    </div>
                    <div class="space-y-1.5">
                        <div v-for="item in checklistPreview" :key="item.label" class="flex items-center gap-2">
                    ...
                    <p class="text-[10px] text-text-muted mt-3">{{ checklistPreview.length }} assets · editable después</p>
                </div>
            </div>
        </div>
    </AppLayout>
