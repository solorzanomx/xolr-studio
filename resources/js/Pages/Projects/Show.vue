...
import { ChevronLeft, Pencil, Trash2, Plus, Tv, ChevronRight, BarChart2, Film } from '@lucide/vue'
    ...
    <AppLayout>
        ...
        <div class="flex items-start justify-between mb-6">
            ...
            <div class="flex gap-2">
                <Link :href="`/projects/${project.id}/publishing`" class="inline-flex items-center gap-2 px-3 py-2 bg-surface-1 border border-border rounded-lg text-sm text-text-secondary hover:text-text-primary transition-colors">
                    <Film class="w-4 h-4" /> Publishing
                </Link>
